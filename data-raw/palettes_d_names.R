...
single_qualitative <- c("pastal.pal", "multi.pal", "Categorical.12", "nrc_npg", "default_aaas",
                        "default_nejm", "lanonc_lancet", "default_jama", "default_jco",
                        "default_ucscgb", "category10_d3", "category20_d3", "category20b_d3",
                        "category20c_d3", "default_igv", "alternative_igv", "default_locuszoom",
                        ...
                        "tableau_tableau20", "tableau_tableau10medium", "tableau_grey5",
                        "tableau_colorblind10", "tableau_trafficlight", "tableau_purplegrey12",
...
single_divergent <- c("BrowntoBlue.10", "BrowntoBlue.12", "BluetoDarkOrange.12",
                      ...
                      "RdYlGn", "Spectral", "dPBlYlBu", "dPBlYlPu", "dPBlPuGn",
                      "dPBlPuOr", "dPBlRdBu", "dPBlRdGy", "dPBlRdGn")
