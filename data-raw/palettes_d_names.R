...
single_qualitative <- c(
  "Categorical.12", "nrc_npg", "default_aaas",
  ...
  "qMSOPu", "tq_light", "tq_dark", "tq_green"
)
single_divergent <- c(
  "BrowntoBlue.10", "BrowntoBlue.12", "BluetoDarkOrange.12",
...
palettes_d_names <- purrr::imap_dfr(
  palettes_d,
  ~ data.frame(
    package = .y,
    palette = names(.x),
