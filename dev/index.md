...
This package includes 2837 palettes from 77 different packages and
...
[`paletteer_c()`](reference/paletteer_c.md),
[`paletteer_d()`](reference/paletteer_d.md) and
[`paletteer_dynamic()`](reference/paletteer_dynamic.md) using the by
using the syntax packagename::palettename.
...
![](reference/figures/paletteer-demo.gif)
...
[![](reference/figures/colorPaletteFinder.gif)](https://r-graph-gallery.com/color-palette-finder)
